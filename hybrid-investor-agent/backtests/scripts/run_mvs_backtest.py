...
if __name__ == '__main__':
    csv_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "data", "synthetic_5m.csv"))
    if not os.path.exists(csv_path):
        raise FileNotFoundError(f"CSV not found at {csv_path}. Create it first under ./data/synthetic_5m.csv")
    ...
    cerebro.addstrategy(MVSStrategy, ema_len=5, donchian_len=5, vol_lookback=5, atr_len=7)
