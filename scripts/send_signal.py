...
def post(body_dict):
    ...
    r = requests.post(URL, headers={"X-Signature": sig, "Content-Type": "application/json"}, data=body)
...
r = requests.post(URL, headers={"X-Signature": sig, "Content-Type": "application/json"}, data=tampered_bytes)
print(r.status_code, r.text)
